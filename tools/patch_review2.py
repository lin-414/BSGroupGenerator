# -*- coding: utf-8 -*-
# 代码审查修复（续）：扫描枚举健壮性、保留设备名、过期扫描数据、控制字符、耗时日志
import io
...
# ── Bug B2：路径解析里的枚举（BodySlideLocator）──
patch('src/BSGroupGenerator/Core/BodySlideLocator.cs', [(
'''        try
        {
...
# ── 测试用例：保留设备名 ──
patch('tests/BSGroupGenerator.Tests/SliderGroupFileTests.cs', [(
